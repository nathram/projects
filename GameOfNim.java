...
public class GameOfNim
{
    public static void main(String[] args)
    {
        ...
        int movecounter = 1;
        System.out.println("Enter 0 to go first, 1 to go second, or 2 to let the Computer to choose. Then enter the # of stones in each pile.");
        Nim game = new Nim(thing.nextInt(), thing.nextInt(), thing.nextInt(), thing.nextInt());
        //calls computerStrat to populate the list of losing positions based on the stones in each pile
        game.computerStrat();
